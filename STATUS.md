...
SCIENTIFIC_RESULTS_STATUS = NOT_GENERATED
...
```text
FASE = PREPARAÇÃO DA BASE E DA ARQUITETURA
```
...
INTERIM_DATA_STATUS = NOT_GENERATED

PROCESSED_DATA_STATUS = NOT_GENERATED
...
```text
PACHECO_STAGE_STATUS = NOT_STARTED
```
