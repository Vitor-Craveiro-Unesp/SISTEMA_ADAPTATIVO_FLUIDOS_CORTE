...
def build_html():
    ...
    def problem_card(number: int, problem: dict[str, object]) -> str:
        ...
        return f'''<article class="plan-card detailed-plan"><div class="problem-number">{number:02d}</div><div class="plan-body">
    ...
    plan_html = "".join(problem_card(number, problem) for number, problem in enumerate(problems, start=1))
    ...
    *{box-sizing:border-box}html{scroll-behavior:smooth}body{margin:0;background:var(--bg);color:var(--ink);font-family:Inter,"Segoe UI",Arial,sans-serif;line-height:1.62}
    ...
    <body><div class="layout"><aside class="sidebar"><div class="brand">Fluidos de Corte</div><div class="brand-sub">Etapa Pacheco + revisão metodológica</div><nav>
      <a href="#visao">Visão geral</a><a href="#importancia">Por que importa</a><a href="#metodo">Método</a><a href="#auditoria">Auditoria</a><a href="#resultados">Resultados</a><a href="#issues">Pendências</a><a href="#plano">Plano técnico</a><a href="#impactos">Efeitos downstream</a><a href="#abertos">Riscos/limitações adicionais</a><a href="#boss">Parecer Boss</a><a href="#codigo">Código</a><a href="#apendices">Apêndices</a>
